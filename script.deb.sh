...
main ()
{
  ...
  apt_config_url="https://packagecloud.io/install/repositories/cs50/repo/config_file.list?os=Ubuntu&dist=jammy&source=script"
  #touch ~/texto.txt
  #echo -n "{$apt_config_url}" >> ~/endereco.txt
